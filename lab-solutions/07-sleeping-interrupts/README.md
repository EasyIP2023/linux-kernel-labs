...
```
$ make -C lab-solutions/07-sleeping-interrupts
$ INSTALL_MOD_PATH="$(pwd)/modules/nfsroot" make -C lab-solutions/07-sleeping-interrupts modules_install
```

**Compiling and Install Userspace IOCTL Examples**

```sh
$ make -C lab-solutions/07-sleeping-interrupts/userspace
$ cp -av lab-solutions/07-sleeping-interrupts/userspace/build/serial-* modules/nfsroot/root
```
